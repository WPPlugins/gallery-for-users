        ...
        <style>
            ...
            <div class="add-wrap">
                <div class="wpug-add-container">
                    ...
                    <div class="actions">
                        <?php echo '<a target="_blank" href="http://togidata.dk/en/shop/gallery-for-users/" class="btn-green">' . __('Upgrade now', 'wc-disable-categories') . '</a>'; ?>
                        <?php echo '<a target="_blank" href="http://togidata.dk/en/user-gallery-plugin-wordpress/" class="btn-white">' . __('Read more and see screenshots', 'wc-disable-categories') . '</a>'; ?>
                    </div>
                </div>
            </div>
        <?php
